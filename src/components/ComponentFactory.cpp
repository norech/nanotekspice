...
Board *ComponentFactory::do4071() {
    ...
    circuit->addComponent("input", "pin_1", "or1_a");
    circuit->addComponent("input", "pin_2", "or1_b");
    circuit->addComponent("output", "pin_3", "or1_s");

    circuit->addComponent("output", "pin_4", "or2_a");
    circuit->addComponent("input", "pin_5", "or2_b");
    circuit->addComponent("input", "pin_6", "or2_s");

    circuit->addComponent("input", "pin_8", "or3_a");
    circuit->addComponent("input", "pin_9", "or3_b");
    circuit->addComponent("output", "pin_10", "or3_s");

    circuit->addComponent("output", "pin_11", "or4_a");
    circuit->addComponent("input", "pin_12", "or4_b");
    circuit->addComponent("input", "pin_13", "or4_s");
...
Board *ComponentFactory::do4069() {
    ...
    circuit->addComponent("input", "pin_1", "not1_i");
    circuit->addComponent("output", "pin_2", "not1_o");

    circuit->addComponent("input", "pin_3", "not2_i");
    circuit->addComponent("output", "pin_4", "not2_o");

    circuit->addComponent("input", "pin_5", "not3_i");
    circuit->addComponent("output", "pin_6", "not3_o");

    circuit->addComponent("input", "pin_9", "not4_i");
    circuit->addComponent("output", "pin_8", "not4_o");

    circuit->addComponent("input", "pin_11", "not5_i");
    circuit->addComponent("output", "pin_10", "not5_o");

    circuit->addComponent("input", "pin_13", "not6_i");
    circuit->addComponent("output", "pin_12", "not6_o");
