...
namespace nts {
    ...
    Pin& Pin::setState(Tristate state) { _state = state; return *this; }

    bool Pin::isVisited(void) const { return _visited; }
    Pin& Pin::visit(void) { _visited = true; return *this; }
    Pin& Pin::unvisit(void) { _visited = false; return *this; }
    ...
    Tristate OutputPin::compute(void)
    {
